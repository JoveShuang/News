...
CREATE TABLE IF NOT EXISTS `cms_basic` (
  `basic_title` varchar(10) NOT NULL,
  `basic_keywords` varchar(10) NOT NULL,
  `basic_description` varchar(255) NOT NULL,
  PRIMARY KEY (`basic_title`)
...
(21, 3, '习近平今日下午出席解放军代表团全体会议', '习近平出席解放军代表团全体会议', '', '/upload/2018/03/23/5ab4b57ccc93c.jpg', '中共中央总书记 国家主席 中央军委主席 习近平', '中共中央总书记', '', 0, 1, '1', 'admin', 1457854896, 0, 16),
...
(23, 3, '重庆美女球迷争芳斗艳', '重庆美女球迷争芳斗艳', '', '/upload/2016/03/13/56e51cbd34470.png', '重庆美女 球迷 争芳斗艳', '重庆美女球迷争芳斗艳', '', 3, 1, '0', 'admin', 1457855680, 0, 4),
...
(32, 3, 'test', 'test', '#5674ed', '/upload/2018/03/16/5aab680b820e9.JPG', 'test', 'test', '', 0, 1, '0', 'admin', 1521182747, 0, 0),
(31, 3, 'test', 'test', '#5674ed', '/upload/2018/03/16/5aab66d3d3ca5.jpg', 'test', 'test', '', 0, 1, '0', 'admin', 1521182714, 0, 0),
(30, 12, 'test1', 'test1', '#ed568b', '/upload/2018/03/16/5aab66d3d3ca5.jpg', 'test1', 'test1', '', 0, 1, '1', 'admin', 1521182428, 0, 0),
(29, 3, 'test', 'test', '#ed568b', '', 'test', 'test', '', 0, 1, '0', 'admin', 1521182290, 0, 0),
(33, 3, 'test', 'test', '#5674ed', '/upload/2018/03/16/5aab680b820e9.JPG', 'test', 'test', '', 0, 1, '0', 'admin', 1521182754, 0, 0),
(34, 3, 'test', 'test', '#5674ed', '/upload/2018/03/16/5aab680b820e9.JPG', 'test', 'test', '', 0, 0, '0', 'admin', 1521183038, 0, 0),
(35, 3, 'test', 'test', '#5674ed', '/upload/2018/03/16/5aab694c0a9e8.jpg', 'test', 'test', '', 0, 0, '0', 'admin', 1521183060, 0, 0),
(36, 3, 'test', 'test', '#ed568b', '/upload/2018/03/16/5aab6977610d0.jpg', 'test', 'test', '', 2, 1, '0', 'admin', 1521183103, 0, 0),
(37, 3, 'test', 'test', '#ed568b', '/upload/2018/03/16/5aab6977610d0.jpg', 'test', 'test', '', 0, -1, '0', 'admin', 1521183123, 0, 0),
