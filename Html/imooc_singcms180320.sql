...
(34, 3, 'test', 'test', '#5674ed', '/upload/2018/03/16/5aab680b820e9.JPG', 'test', 'test', '', 0, 1, '0', 'admin', 1521183038, 0, 0),
(35, 3, 'test', 'test', '#5674ed', '/upload/2018/03/16/5aab694c0a9e8.jpg', 'test', 'test', '', 0, 1, '0', 'admin', 1521183060, 0, 0),
...
(34, 2, '重庆美女球迷争芳斗艳', '/upload/2016/03/13/56e51cbd34470.png', NULL, 23, 0, 1, 1457855680, 0),
...
--
ALTER TABLE `cms_admin`
  MODIFY `admin_id` mediumint(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `cms_news`
  MODIFY `news_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
